...
def show_country_page(root, mode_button_text):
    ...
    ttk.Button(fac_frame, text="📅 Make a Reservation",
           command=lambda: make_reservation.show_reservation_page(root, mode_button_text, hotel_id=4),
    ...
    image_refs = []
    image_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "photos", "greece"))
